...
.factory('queryParamsInterceptor', function(Session, GeoService, TrackService, gampConfig, $localstorage) {
	...
	return {
		...
		request: function(config) {	
			...
			// params.push('lat=' +  gampConfig.lat);
			// params.push('long=' + gampConfig.long);
