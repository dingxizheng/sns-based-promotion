...
.constant('gampConfig', {
	...
	mode: 'production', // test, development or production

	init: function () {
		if (this.mode === 'test') 
			this.baseUrl = 'http://vicinity-deals-test-3hqca6tun5.elasticbeanstalk.com';
		else if (this.mode === 'development')
			this.baseUrl = 'http://localhost:3000';
		else 
			this.baseUrl = 'http://rails-api-env-b4cm2bfxbr.elasticbeanstalk.com';
	},
