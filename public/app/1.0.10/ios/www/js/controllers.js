...
.controller('SearchCtrl', function($injector, $scope, $ionicSideMenuDelegate, Search, User, Promotion, initQuery, $ionicScrollDelegate, Session, $state, ControllerService, $localstorage, TrackService, AutoSuggest) {
